...
16. **[0.2.3]** Sistema de selecao de fonte com `Style > Font... (Ctrl+P,=)`:
...
17. **[0.2.3]** Implementacao de `Style > Bold (Ctrl+P,B)` com toggle por aba.
    - Regua de linhas, regua flutuante e floating ruler adaptam a novas metricas de fonte.
18. **[0.2.3]** Melhorias na tela `Configure`:
...
19. **[0.2.3]** Implementacao de consumo real de paths de ferramentas:
